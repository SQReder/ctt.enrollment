        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    Title = table.Column<string>(maxLength: 100, nullable: true),
                    UnityGroupId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Trustees_AlternateId", x => x.AlternateId);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_Trustees_AspNetUsers_OwnerID",
                        column: x => x.OwnerID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrusteeId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Enrollees", x => x.Id);
                    table.UniqueConstraint("AK_Enrollees_AlternateId", x => x.AlternateId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Enrollees_Trustees_TrusteeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnrolleeId = table.Column<Guid>(nullable: false),
                    TrusteeId = table.Column<Guid>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Admissions_Trustees_TrusteeId",
                        column: x => x.TrusteeId,
                        principalTable: "Trustees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
