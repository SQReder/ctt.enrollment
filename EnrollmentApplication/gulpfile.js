/// <binding AfterBuild='bump' Clean='clean' />
'use strict';
...
gulp.task('rxjs', function () {
    return gulp.src(paths.rxjsall).pipe(gulp.dest(paths.webroot + '/lib/rxjs'));
});

gulp.task('pace', function () {
    return gulp.src(paths.pace).pipe(gulp.dest(paths.webroot + '/lib/pace'));
});
gulp.task('lib', ['angular2', 'rxjs', 'pace'], function () {
