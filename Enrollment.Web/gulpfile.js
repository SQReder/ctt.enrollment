...
gulp.task("uikit", function() {
    return gulp.src(paths.uikit).pipe(gulp.dest(paths.libTarget + "/uikit"));
});

gulp.task("lib", ["angular2", "rxjs", "pace", "symbol-observable", "uikit"], function () {
