...
namespace Enrollment.Api.Controllers
{
    [Authorize]
    [Route("api/me")]
    public class CurrentTrusteeController: Controller
    {
        ...
        public GenericResult GetMe()
        {
            ...
            try
            {
                ...
                result = new GenericDataResult<TrusteeViewModel>(viewModel);
            }
            catch (Exception e)
            {
        ...
        public GenericResult GetEnrollees()
        {
            ...
            try
            {
                ...
                var enrollees = trustee?.Enrollees ?? Enumerable.Empty<Enrollee>();

                result = new GenericDataResult<IEnumerable<Enrollee>>(enrollees);
            }
            catch (Exception e)
            {
                result = new ErrorResult(e);
        ...
        public async Task<GenericResult> CreateEnrolle([FromBody] EnrolleeViewModel model)
        {
            ...
            try
            {
                ...
                var trustee = await DataContext.Trustees
                    .Include(x => x.Enrollees)
                    .FirstOrDefaultAsync(x => x.OwnerID == _currentUserHelper.Guid());

                trustee.Enrollees.Add(enrollee);

                await DataContext.SaveChangesAsync();

                result = new GenericDataResult<Guid>(enrollee.Id);
            }
            catch (Exception e)
            {
                result = new ErrorResult(e);
        ...
        public async Task<GenericResult> GetEnrollee(Guid id)
        {
            ...
            try
            {
                ...
                result = new GenericDataResult<Enrollee>(enrollee);
            }
            catch (Exception e)
            {
                result = new ErrorResult(e);
        ...
        public async Task<GenericResult> ListMyAdmissions()
        {
            ...
            try
            {
                ...
                result = new GenericDataResult<IEnumerable<Admission>>(admissions);
            }
            catch (Exception e)
            {
                result = new ErrorResult(e);
